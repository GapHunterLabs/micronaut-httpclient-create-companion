package dev.gaphunter.micronauthttpclientcreatecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.micronauthttpclientcreatecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.micronauthttpclientcreatecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Micronaut HttpClient Create Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33898-micronaut-httpclient-create-companion/reviews"
